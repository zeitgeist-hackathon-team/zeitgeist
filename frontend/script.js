$(document).ready(() => {
  ...
  const getQuestions = async () => {
    ...
    */
    ...
    //   $(this).toggleClass('clicked');
    //   $('.south').text((i, text) => text === 'Sent!' ? 'South' : 'Sent!');
    // });
    // $('.east-button').click(function () {
    //   $(this).toggleClass('clicked');
    //   $('.east').text((i, text) => text === 'Sent!' ? 'East' : 'Sent!');
    // });
    // $('.west-button').click(function () {
    //   $(this).toggleClass('clicked');
    //   $('.west').text((i, text) => text === 'Sent!' ? 'West' : 'Sent!');
    // });
  };
